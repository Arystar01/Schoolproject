...
void display_supervisor_functions(struct book *);
struct book *initialize_lib();
...
{
    struct book *new_book = create_book();
...
void display_supervisor_functions(struct book *first_book)
{
    ...
    do
    {
        ...
        int choose_functions;
        scanf("%d", &choose_functions);
        switch (choose_functions)
        {
        case 1:
...
int main()
{
    // create_book();
    initialize_lib();
    display_supervisor_functions(first_book);
    printf("||||                                   WELCOME TO THE LIBRARY PORTAL                                                    ||||\n");
    printf("                                    AUTHORIZED ONLY FOR LIBRARY STAFFS                                                      \n");
    printf("\n \n \n");
