...
void greetings()
{
    ...
    printf("\t\t\t     *                                      *\n");
    printf("\t\t\t     *                                      *\n");
    printf("\t\t\t     *         Meerut,U.P.,India         *\n");
    printf("\t\t\t     *      Email: aero12@gmail.com       *\n");
    printf("\t\t\t     *     Contact:8080706050,567689        *\n");
    printf("\t\t\t     *                                      *\n");
}
...
struct book *initialize_lib(struct book *start)
{
    ...
    new_book1->next = NULL;
    start_lib = new_book1;
    strcpy(new_book1->name, "Concept of Physics");
    strcpy(new_book1->author, "H.C. Verma");
    new_book1->id = 101;
    ptr = new_book1;

    new_book2 = (struct book *)malloc(sizeof(struct book));
    new_book2->next = NULL;
    strcpy(new_book2->name, "Objective Organic Chemistry");
    strcpy(new_book2->author, "Akshay Chaudhry");
    new_book2->id = 102;
    ptr->next = new_book2;
    ptr = new_book2;
    ...
    new_book3->next = NULL;
    strcpy(new_book3->name, "The Hidden Hindu");
    strcpy(new_book3->author, "Akshit Gupta");
    new_book3->id = 103;
    ptr->next = new_book3;
    ptr = new_book3;
    ...
    new_book5->next = NULL;
    strcpy(new_book5->name, "Engineering of Yoga");
    strcpy(new_book5->author, "Sadguru");
    new_book5->id = 105;
    ptr->next = new_book5;
...
struct book *add_new_book(struct book *start)
{
    struct book *ptr, *new_book;
    ptr = start;
    while (ptr != NULL)
